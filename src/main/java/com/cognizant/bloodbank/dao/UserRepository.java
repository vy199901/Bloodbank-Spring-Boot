...
public interface UserRepository extends JpaRepository<User, Integer> {
	...
	@Query(value="select *,0 as 'CLAZZ_' from user where user_id in (select donor_id from donor where blood_group = :blood_group) and location=:location",nativeQuery = true)
